...
'''
#Ejercicio 1: iterar un rango de 0 a 10 e imprimir numeris divisibles entre 3
...
#Ejercicio 3: Crear un rango de numeros de 2 a 6 pero con incremento de 2 en 2, en lugar de 1 en 1
# Ejemplo de ejecucion: 3,5,7,9
