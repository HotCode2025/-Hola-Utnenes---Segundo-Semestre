...
//import ar.com.codesystem.*; el * nos importa todo
...
public class TestUtileria {
    public static void main(String[] args) {
        ...
        //ar.com.codesystem.Utileria.imprimir("Ahora si estamos terminando"); //Es la menos recomendable porque es dificil de leer
    }
}
